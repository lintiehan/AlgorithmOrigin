...
public class BinaryTree {
	...
	public static TreeNode Merge(TreeNode subTree) throws Exception {
		if (subTree != null && subTree.leftChild != null && subTree.rightChild != null) {
			...
			/*System.out.println(
					"Merge------>执行的节点?�?" + subTree.key + " �?签为:" + subTree.label + " 是否可操�?-----" + subTree.isVisted);
			System.out.println("Merge------>ִ左孩�?" + subTree.leftChild.key + " �?签为:" + subTree.leftChild.label);
			System.out.println("Merge------>ִִ右孩�?" + subTree.rightChild.key + " �?签为:" + subTree.rightChild.label);
*/
			if (parent != null && subTree.isVisted == true && subTree.leftChild.label == "TLeafL"
				...
				/*System.out.println("Merge-root-TNodeR-->" + newnode.leftChild.key + " " + newnode.centerChild.key + " "
						+ newnode.rightChild.key);*/
			...
			/*	System.out.println("Merge-root-TNodeL-->" + newnode.leftChild.key + " " + newnode.centerChild.key + " "
						+ newnode.rightChild.key);
				System.out.println();*/
				subTree = newnode;
			} else if (parent == null && subTree.isVisted == true && subTree.leftChild.label == "TLeafL"
				...
				/*System.out.println("Merge-root-TNodeN-->" + newnode.leftChild.key + " " + newnode.centerChild.key + " "
						+ newnode.rightChild.key);
				System.out.println();*/
				subTree = newnode;
			}
	...
	public static TreeNode Merge2(TreeNode newroot, TreeNode subTree) throws Exception {
		if (subTree != null && subTree.leftChild != null && subTree.rightChild != null) {
			...
			/*System.out.println("Merge2------>ִ执行的节点:" + subTree.key + " �?签为?�?" + subTree.label + " 是否可操作�?-----" + subTree.isVisted);
			System.out.println("Merge2------>ִ左孩�?:" + subTree.leftChild.key + " �?签为?�?" + subTree.leftChild.label+ " 是否可操作�?-----" + subTree.leftChild.isVisted);
			System.out.println("Merge2------>ִ右孩�?:" + subTree.rightChild.key + " �?签为?�?" + subTree.rightChild.label+ " 是否可操作�?-----" + subTree.rightChild.isVisted);
			System.out.println();
		*/	// kind 1
			if (isAllow(subTree)&&(subTree.isVisted == true && subTree.leftChild.label == "TLeafL"
					&& subTree.rightChild.label != "TLeafN")||
			...
			// kind 4
			else if (isAllow(subTree)&&subTree.isVisted == true 
					&& subTree.leftChild.label  == "TNodeN"
					&& subTree.rightChild.label == "TLeafN") {
			...
			// kind 5
			else if (isAllow(subTree)&&subTree.isVisted == true && subTree.label == "TLeafN" && subTree.leftChild.label == "TNodeN"
					&& subTree.rightChild.label == "TNodeN"  
				) {				
			...
			// kind 6
					...
					(isAllow(subTree)&&subTree.isVisted == true && subTree.label == "TLeafN" && subTree.leftChild.label == "TNodeL"
					&& subTree.rightChild.label == "TNodeN") ||
					(isAllow(subTree)&&subTree.isVisted == true && subTree.label == "TLeafN" && subTree.leftChild.label == "TNodeR"
					&& subTree.rightChild.label == "TNodeN" )) {
			...
			// kind 7
					...
					&& subTree.rightChild.label == "TNodeL")||
					(isAllow(subTree)&&subTree.isVisted == true && subTree.label == "TLeafN" && subTree.leftChild.label == "TNodeN"
					&& subTree.rightChild.label == "TNodeR")) {
			...
			// kind 8
				...
				/*System.out.println("kind 8-->"+newnode.leftChild.label
						...
						+" "+newnode.rightChild.label);*/
				newnode.key = getKey(newnode.label); 	
				//System.out.println("新节点�?签?�?" + newnode.label + newnode.key);
			...
			// kind 9
			else if ((isAllow(subTree)&&subTree.isVisted == true && subTree.label != "TLeafN" && subTree.leftChild.label == "TNodeL"
					&& subTree.rightChild.label == "TNodeN")
					|| (isAllow(subTree)&&subTree.isVisted == true && subTree.label != "TLeafN" && subTree.leftChild.label == "TNodeR"
							&& subTree.rightChild.label == "TNodeN")) {
...
//					
	...
	private static TreeNode rightmeger1(TreeNode parent, TreeNode subTree) {
		...
		if (subTree.rightChild.label == "TNodeN") {
			if (subTree.label == "TLeafN") {
				...
				newnode.label = "TNodeN";
				newnode.key = 888; 	 
				//System.out.println("rightmeger1.1--->TNodeN " + newnode.leftChild.key + " " + newnode.centerChild.key+" "+newnode.rightChild.key);
			} else {
			//	System.out.println("rightmeger1.2--->TNodeN");
				...
				newnode.label = getLabel(newnode);
				newnode.key = getKey(newnode.label);				 
				//System.out.println("rightmeger1.2--->TNodeN " + newnode.leftChild.key + " " + newnode.centerChild.key+" "+newnode.rightChild.key);
			}	 
			...
			/*	System.out.println("rightmeger1--TNodeR->" + newnode.leftChild.key + " " + newnode.centerChild.key + " "
					+ newnode.rightChild.key);*/
			...
			//	System.out.println("rightmeger1.2--->TNodeN   22");
				...
				newnode.key = 999;	
				newnode.isVisted=true;
		/*		System.out.println("rightmeger1--TNodeL->" + newnode.leftChild.key + " " + newnode.centerChild.key + " "
					+ newnode.rightChild.key);
			*/
	...
	/*	System.out.println("Merge-TNodeL-->" + newnode.key + ":" + newnode.leftChild.key + " " + newnode.centerChild.key
				+ " " + newnode.rightChild.key);
		System.out.println();*/
		return newnode;
	}
	...
	/*	System.out.println("Merge-TNodeR-->" + newnode.key + ":" + newnode.leftChild.key + " " + newnode.centerChild.key
				+ " " + newnode.rightChild.key);
		System.out.println();*/
		return newnode;
	}
	...
	private static TreeNode twinmeger(TreeNode parent, TreeNode subTree) {
		...
		/*System.out.println("Merge-TNodeN-->" + temp.key + ":" + temp.leftChild.key + " " + temp.centerChild.key + " "
				+ temp.rightChild.key);
		System.out.println();*/
		return temp;
	}
		...
		if (node != null && node.leftChild != null && node.centerChild != null && node.rightChild != null) {
			...
			if (node.rightChild.label == "") {
					 ...
					 ) 
			 {
				...
				System.out.print ("该节点赋�?�失败:左"+node.leftChild.label);
				System.out.print (" :中"+node.centerChild.label);
				System.out.print (" :右"+node.rightChild.label);
				 System.out.println();
				label = "failed";			 
			}
